...
public class LoginActivity extends AppCompatActivity {
    ...
    private void LoginPKCS() {
        // Get Verifier.
        SecureRandom sr = new SecureRandom();
        byte[] code = new byte[32];
        sr.nextBytes(code);
        String verifier = Base64.encodeToString(code, URL_SAFE | Base64.NO_WRAP | Base64.NO_PADDING);
        Toast.makeText(getApplicationContext(), "Made Verifier = " + verifier, Toast.LENGTH_LONG).show();
        ...
        try {
            ...
            String challenge = Base64.encodeToString(digest, URL_SAFE);
            Toast.makeText(getApplicationContext(), "Made Challenge = " + challenge, Toast.LENGTH_LONG).show();
